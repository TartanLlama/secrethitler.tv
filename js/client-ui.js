...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/client-ui.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
var ClientProtocol = __webpack_require__(/*! client-protocol */ "./src/client-protocol.ts");
var client_protocol_1 = __webpack_require__(/*! client-protocol */ "./src/client-protocol.ts");
...
try {
    ws.connect().then(function (f) { return showGUI(); });
}
catch (err) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ws.request({ method: 'POST', path: '/client_action', payload: payload })];
...
function reconnect(name) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sendAction(client_protocol_1.ClientAction.Reconnect, { name: name })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function readyToPlay(event) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ReactDOM.render(React.createElement("h1", null, "Wait for everyone else to be ready."), document.getElementById('root'));
                    return [4 /*yield*/, sendAction(client_protocol_1.ClientAction.Ready, { name: name })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function selectPresident(name) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sendAction(client_protocol_1.ClientAction.SelectPresident, { name: name })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function selectChancellor(name) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sendAction(client_protocol_1.ClientAction.SelectChancellor, { name: name })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function kill(name) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sendAction(client_protocol_1.ClientAction.Kill, { name: name })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function peekComplete(event) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sendAction(client_protocol_1.ClientAction.PeekComplete)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function investigationComplete(event) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sendAction(client_protocol_1.ClientAction.InvestigationComplete)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function investigate(name) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sendAction(client_protocol_1.ClientAction.Investigate, { name: name })];
                case 1:
                    role = _a.sent();
...
function vote(v) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ReactDOM.render(React.createElement("h1", null, "Wait for everyone else's votes"), document.getElementById('root'));
                    return [4 /*yield*/, sendAction(client_protocol_1.ClientAction.Vote, { vote: v })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function discard(n) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ReactDOM.render(React.createElement("h1", null, "Wait for the chancellor to play"), document.getElementById('root'));
                    remainder = currentCards.filter(function (c, idx) { return idx != n; });
                    return [4 /*yield*/, sendAction(client_protocol_1.ClientAction.Discard, { discard: currentCards[n], remainder: remainder })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function play(n) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ReactDOM.render(React.createElement("h1", null, "Wait for the next round"), document.getElementById('root'));
                    remainder = currentCards.filter(function (c, idx) { return idx != n; });
                    return [4 /*yield*/, sendAction(client_protocol_1.ClientAction.Play, { play: currentCards[n], discard: remainder[0] })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function handleServerMessage(message) {
    if (message.event === ClientProtocol.ClientEvent.StartGame) {
        ReactDOM.render(React.createElement("div", null,
            ...
            message.otherRoles.map(function (p) { return React.createElement("h2", null,
                p.name,
                " is ",
                roleName(p.role)); }),
        ...
        ReactDOM.render(React.createElement("h1", null,
            "Wait for ",
            message.president,
            " to choose chancellor."), document.getElementById('root'));
    }
        ...
        ReactDOM.render(React.createElement("h1", null, "Wait for the president and chancellor to play"), document.getElementById('root'));
    }
...
function startGame(event) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sendAction(client_protocol_1.ClientAction.StartGame)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
var NameForm = /** @class */ (function (_super) {
    ...
    NameForm.prototype.handleNameChange = function (event) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        event.preventDefault();
                        return [4 /*yield*/, sendAction(client_protocol_1.ClientAction.Register, { name: this.state['name'] })];
                    case 1:
                        response = _a.sent();
...
/******/ });
//# sourceMappingURL=client-ui.js.map
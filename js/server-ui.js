...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/server-ui.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
(function (ServerEvent) {
    ServerEvent[ServerEvent["DisplayRegistered"] = 0] = "DisplayRegistered";
    ServerEvent[ServerEvent["DisplayBoard"] = 1] = "DisplayBoard";
...
var Nes = __webpack_require__(/*! nes */ "./node_modules/nes/dist/client.js");
var ServerProtocol = __webpack_require__(/*! server-protocol */ "./src/server-protocol.ts");
...
;
var range = function (start, end) { return Array.from({ length: (end - start) }, function (v, k) { return k + start; }); };
var LiberalMat = /** @class */ (function (_super) {
    __extends(LiberalMat, _super);
    function LiberalMat() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    LiberalMat.prototype.render = function () {
        return React.createElement("img", { src: "../assets/liberal-mat.png", style: { width: '80%' } });
    };
    return LiberalMat;
}(React.Component));
var FascistMat = /** @class */ (function (_super) {
    __extends(FascistMat, _super);
    function FascistMat() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    FascistMat.prototype.render = function () {
        var nPlayers = this.props.nPlayers;
        var mat = (nPlayers % 2 == 0) ? nPlayers - 1 : nPlayers;
        var url = "../assets/fascist-mat-" + mat + ".png";
        return React.createElement("img", { src: url, style: { width: '80%', paddingLeft: '10%' } });
    };
    return FascistMat;
}(React.Component));
var PresidentPlaque = /** @class */ (function (_super) {
    __extends(PresidentPlaque, _super);
    function PresidentPlaque() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PresidentPlaque.prototype.render = function () {
        return React.createElement("img", { src: "../assets/president.png", style: { width: '17vw', opacity: this.props.opacity } });
    };
    return PresidentPlaque;
}(React.Component));
var ChancellorPlaque = /** @class */ (function (_super) {
    __extends(ChancellorPlaque, _super);
    function ChancellorPlaque() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ChancellorPlaque.prototype.render = function () {
        return React.createElement("img", { src: "../assets/chancellor.png", style: { width: '17vw', opacity: this.props.opacity } });
    };
    return ChancellorPlaque;
}(React.Component));
var DrawPile = /** @class */ (function (_super) {
    ...
    DrawPile.prototype.render = function () {
        return React.createElement("img", { src: "../assets/draw-pile.png", style: { width: '10%', top: '50%', transform: 'perspective(1px) translateY(-50%)' } });
    };
    return DrawPile;
}(React.Component));
var DiscardPile = /** @class */ (function (_super) {
    ...
    DiscardPile.prototype.render = function () {
        return React.createElement("img", { src: "../assets/discard-pile.png", style: { width: '10%', top: '50%', transform: 'perspective(1px) translateY(-50%)' } });
    };
    return DiscardPile;
}(React.Component));
var BrexitCounter = /** @class */ (function (_super) {
    __extends(BrexitCounter, _super);
    function BrexitCounter() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BrexitCounter.prototype.render = function () {
        return React.createElement("img", { src: "../assets/5p.png", style: { position: 'absolute',
                width: '3%',
                top: '77%',
                left: (36.5 + 7.5 * this.props.count) + '%' } });
    };
    return BrexitCounter;
}(React.Component));
var LiberalPolicies = /** @class */ (function (_super) {
    __extends(LiberalPolicies, _super);
    function LiberalPolicies() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    LiberalPolicies.prototype.render = function () {
        return range(0, this.props.count).map(function (n) {
            return React.createElement("img", { src: "../assets/liberal-policy.png", style: { position: 'absolute', width: '10%', top: '24%', left: (22.7 + 11 * n) + '%' } });
        });
    };
    return LiberalPolicies;
}(React.Component));
var FascistPolicies = /** @class */ (function (_super) {
    __extends(FascistPolicies, _super);
    function FascistPolicies() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    FascistPolicies.prototype.render = function () {
        return range(0, this.props.count).map(function (n) {
            return React.createElement("img", { src: "../assets/fascist-policy.png", style: { position: 'absolute', width: '10%', top: '125%', left: (17 + 11 * n) + '%' } });
        });
    };
    return FascistPolicies;
}(React.Component));
var VoteCard = /** @class */ (function (_super) {
    __extends(VoteCard, _super);
    function VoteCard() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    VoteCard.prototype.render = function () {
        if (this.props.hidden) {
            return React.createElement("img", { src: "../assets/vote-card-back.png", style: { width: '7vw' } });
        }
        if (this.props.vote) {
            return React.createElement("img", { src: "../assets/ja.png", style: { width: '7vw' } });
        }
        return React.createElement("img", { src: "../assets/nein.png", style: { width: '7vw' } });
    };
    return VoteCard;
}(React.Component));
var Players = /** @class */ (function (_super) {
    ...
    Players.prototype.render = function () {
        var _this = this;
        return React.createElement("div", { style: { display: 'flex' } }, this.props.players.map(function (p) {
            return React.createElement("div", { style: { flex: '1', textAlign: 'center' } },
                p.dead ? React.createElement("p", null,
                    React.createElement("del", null, p.name)) : React.createElement("p", null, p.name),
                p.vote == null ? "" : React.createElement(VoteCard, { hidden: p.voteHidden, vote: p.vote }),
                _this.props.president === p.name ? React.createElement(PresidentPlaque, { opacity: 1 }) : "",
                _this.props.lastPresident === p.name ? React.createElement(PresidentPlaque, { opacity: 0.5 }) : "",
                _this.props.chancellor === p.name ? React.createElement(ChancellorPlaque, { opacity: 1 }) : "",
                _this.props.lastChancellor === p.name ? React.createElement(ChancellorPlaque, { opacity: 0.5 }) : "");
        }));
    };
    return Players;
}(React.Component));
function renderPlayerList(names) {
    ReactDOM.render(React.createElement("ul", null, names.map(function (name) { return React.createElement("li", null, name); })), document.getElementById('root'));
}
function renderBoardState(gameState) {
    ReactDOM.render(React.createElement("div", { style: { width: '100%' } },
        React.createElement(Players, { president: gameState.president, lastPresident: gameState.lastPresident, chancellor: gameState.chancellor, lastChancellor: gameState.lastChancellor, players: gameState.players.slice(gameState.players.length / 2, gameState.players.length) }),
        React.createElement("div", { style: { position: 'relative' } },
            React.createElement(DrawPile, null),
            React.createElement(LiberalMat, null),
            React.createElement(LiberalPolicies, { count: gameState.nLiberalsPlayed }),
            React.createElement(FascistPolicies, { count: gameState.nFascistsPlayed }),
...
function init() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ws.connect()];
                case 1:
                    _a.sent();
                    ws.onUpdate = handleServerMessage;
                    return [4 /*yield*/, ws.request('/register_ui')];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
...
ReactDOM.render(React.createElement(Root, { id: "root" }), document.getElementById('container'));
init();
